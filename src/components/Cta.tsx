    ...
    <section className="section">
        <div className="container">
            <motion.div variants={variants.fadeInUp} 
                ...
                whileInView='end'
                viewport={{once: true}}
                className="bg-primar rounded-xl border-t border-primary-foreground/30 overflow-hidden grid grid-cols-1 lg:grid-cols-[1fr,0.7fr] lg:items-center" 
                ...
                <div className=" p-8 md:p-16 xl:p-20">
                    ...
                    <motion.div 
                     ...
                     whileInView='end'
                     viewport={{once: true}}
                    className="flex item-center gap-3 lg:gap-4">
